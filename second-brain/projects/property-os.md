...
- **Excel reconciliation** (May 27): Updated Excel file resolved the long-running purchase price discrepancy in favor of $210,000 and updated the FLIP CALCULATOR rehab budget to $75,000. Seven new expenses dated April 14 through May 19 were imported into the DB totaling $7,748.03, bringing DB and Excel into effective sync around $79,158 total with only a trivial rounding gap. The project is now about $4,158 over the $75,000 rehab budget, and projected net at a $360,000 ARV drops to about $49,000 after 6% sell costs.
- **Weekly flip check-in** (June 1): Project still shows "Rehab - Final" at about 90% complete, unchanged for 11 straight weeks since mid-March, with no new DB expenses since the May 27 reconciliation batch and no visible move into listing prep. Estimated holding since May 18 added about $1,137, bringing estimated total holding near $16,457, estimated total project spend near $77,095, and estimated basis near $287,095. The main blocker remains whether rehab is truly done and should move immediately into listing, or whether punch-list work is still unfinished but not being tracked.
- **Excel reconciliation** (June 3): Excel was updated with 7 missing entries totaling $7,748.03, and the FLIP CALCULATOR rehab budget was updated from $55,000 to $75,000. Current DB total now stands at $75,957.67 across 74 entries, with rehab spend at $60,637.38 and holding costs at $15,320.29. The project is slightly over the $75,000 total budget while still showing the purchase price as $160,000 in the tracker pending Nathan's confirmation on whether it should instead be revised to $210,000.
- **Weekly flip check-in** (June 8): Project remains stuck in Rehab - Final at about 90% complete, now unchanged for 12 straight weeks since mid-March, with no new activity since May 19. Estimated total cost rose to about $76,364 after additional holding burn, and the core operational question remains whether the rehab is actually complete and should move directly into listing prep, or whether unfinished punch-list work still exists but is not being tracked.
